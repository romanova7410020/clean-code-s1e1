...
var addButton=document.getElementsByClassName("add-task")[0];//first button
...
var editTask=function(){
    ...
    var editInput=listItem.querySelector('input.input-edit');
    var label=listItem.querySelector('label.label-task');
